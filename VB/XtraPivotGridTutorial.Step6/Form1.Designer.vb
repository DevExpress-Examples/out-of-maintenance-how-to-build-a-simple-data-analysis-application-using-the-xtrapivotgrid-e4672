...
Namespace XtraPivotGridTutorial
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.pivotLink = New DevExpress.XtraPrinting.PrintableComponentLink(Me.components)
			...
			Me.exportingToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
			Me.exportToXLSXToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
			Me.menuStrip1 = New System.Windows.Forms.MenuStrip()
			CType(Me.xtraPivotGridTutorialBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
			...
			CType(Me.pivotLink.ImageCollection, System.ComponentModel.ISupportInitialize).BeginInit()
			CType(Me.compositeLink1.ImageCollection, System.ComponentModel.ISupportInitialize).BeginInit()
			CType(Me.chartLink.ImageCollection, System.ComponentModel.ISupportInitialize).BeginInit()
			...
			Me.splitContainerControl1.Size = New System.Drawing.Size(732, 517)
			...
			Me.splitContainerControl2.Panel1.Controls.Add(Me.pivotGridControl1)
			Me.splitContainerControl2.Panel1.Text = "Panel1"
			Me.splitContainerControl2.Panel2.Controls.Add(Me.chartControl1)
			Me.splitContainerControl2.Panel2.Text = "Panel2"
			Me.splitContainerControl2.Size = New System.Drawing.Size(415, 517)
			...
			Me.pivotGridControl1.Size = New System.Drawing.Size(415, 326)
			...
			Me.fieldExtendedPrice1.AreaIndex = 2
			...
			Me.fieldFreightPercentage.Visible = False
			' 
			' chartControl1
			' 
			...
			Me.chartControl1.SeriesTemplate.CrosshairLabelPattern = "{S} : {V:C2}"
			...
			Me.chartControl1.Size = New System.Drawing.Size(415, 186)
			...
			Me.printableComponentLink2.Owner = Nothing
			Me.printableComponentLink2.PrintingSystem = Nothing
			Me.printableComponentLink2.PrintingSystemBase = Nothing
			' 
			' printingSystem1
			' 
			Me.printingSystem1.Links.AddRange(New Object() { Me.pivotLink, Me.chartLink, Me.compositeLink1})
			' 
			' pivotLink
			' 
			Me.pivotLink.Component = Me.pivotGridControl1
			' 
			' 
			' 
			Me.pivotLink.ImageCollection.ImageStream = (CType(resources.GetObject("pivotLink.ImageCollection.ImageStream"), DevExpress.Utils.ImageCollectionStreamer))
			Me.pivotLink.Owner = Me.compositeLink1
			Me.pivotLink.PrintingSystem = Me.printingSystem1
			Me.pivotLink.PrintingSystemBase = Me.printingSystem1
			' 
			' compositeLink1
			' 
			' 
			...
			Me.compositeLink1.Links.AddRange(New Object() { Me.pivotLink, Me.chartLink})
			...
			' 
			' 
			Me.chartLink.ImageCollection.ImageStream = (CType(resources.GetObject("chartLink.ImageCollection.ImageStream"), DevExpress.Utils.ImageCollectionStreamer))
			Me.chartLink.Owner = Me.compositeLink1
			Me.chartLink.PrintingSystem = Me.printingSystem1
			Me.chartLink.PrintingSystemBase = Me.printingSystem1
			' 
			' printingToolStripMenuItem
			' 
			Me.printingToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() { Me.previewToolStripMenuItem})
			Me.printingToolStripMenuItem.Name = "printingToolStripMenuItem"
			Me.printingToolStripMenuItem.Size = New System.Drawing.Size(44, 20)
			Me.printingToolStripMenuItem.Text = "Print"
			' 
...
'			Me.previewToolStripMenuItem.Click += New System.EventHandler(Me.previewToolStripMenuItem_Click_1);
			' 
			' exportingToolStripMenuItem
			' 
			Me.exportingToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() { Me.exportToXLSXToolStripMenuItem})
			Me.exportingToolStripMenuItem.Name = "exportingToolStripMenuItem"
			Me.exportingToolStripMenuItem.Size = New System.Drawing.Size(52, 20)
			Me.exportingToolStripMenuItem.Text = "Export"
			' 
			' exportToXLSXToolStripMenuItem
			' 
			Me.exportToXLSXToolStripMenuItem.Name = "exportToXLSXToolStripMenuItem"
			Me.exportToXLSXToolStripMenuItem.Size = New System.Drawing.Size(150, 22)
			Me.exportToXLSXToolStripMenuItem.Text = "Export to XLSX"
'			Me.exportToXLSXToolStripMenuItem.Click += New System.EventHandler(Me.exportToXLSXToolStripMenuItem_Click);
			' 
			' menuStrip1
			' 
			Me.menuStrip1.Items.AddRange(New System.Windows.Forms.ToolStripItem() { Me.printingToolStripMenuItem, Me.exportingToolStripMenuItem})
			...
			Me.ClientSize = New System.Drawing.Size(732, 541)
			Me.Controls.Add(Me.splitContainerControl1)
			Me.Controls.Add(Me.menuStrip1)
			Me.Name = "Form1"
			Me.Text = "XtraPivotGridTutorial.Step6"
'			Me.Load += New System.EventHandler(Me.Form1_Load);
			CType(Me.xtraPivotGridTutorialBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
			...
			CType(Me.pivotLink.ImageCollection, System.ComponentModel.ISupportInitialize).EndInit()
			CType(Me.compositeLink1.ImageCollection, System.ComponentModel.ISupportInitialize).EndInit()
			CType(Me.chartLink.ImageCollection, System.ComponentModel.ISupportInitialize).EndInit()
		...
		Private pivotLink As DevExpress.XtraPrinting.PrintableComponentLink
		...
		Private printingToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
		Private exportingToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
		Private menuStrip1 As System.Windows.Forms.MenuStrip
		Private WithEvents previewToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
		Private WithEvents exportToXLSXToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
	End Class
End Namespace
